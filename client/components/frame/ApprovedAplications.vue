<template>
  <div v-for="application of frameApplicationsStore.approvedFrameApplications">
    <div class="relative w-full mb-20 card-style">
      ...
      <div class="font-semibold text-3xl mt-10 mb-3 max-md:text-xl">
        Описание
      </div>
      <div class="text-2xl max-md:text-xl break-all">
      ...
      <div
        class="flex justify-between max-sm:adaptive-flex-col max-sm:text-center md:max-lg:adaptive-flex-col md:max-lg:text-center"
      >
        <NuxtLink
          class="max-sm:w-full max-sm:mb-3 md:max-lg:w-full md:max-lg:mb-3"
          :to="`/frame/invites/${application.applicationId}`"
        >
          <div class="black-btn">Назначить стажера</div>
        </NuxtLink>
        <div
          class="flex max-sm:adaptive-flex-col max-sm:text-center max-sm:w-full max-sm:gap-y-3 md:max-lg:adaptive-flex-col md:max-lg:text-center md:max-lg:w-full md:max-lg:gap-y-3"
        >
          <NuxtLink
            class="max-sm:w-full md:max-lg:w-full"
            :to="`/frame/edit/${application.applicationId}`"
          >
            <div class="black-btn me-5 max-sm:me-0 md:max-lg:me-0">
              Редактировать
            </div>
          </NuxtLink>
          <div
