<template>
    <div v-if="application" class="text-2xl py-5 px-10 w-1/2 mx-auto shadow-slate-950 shadow-2xl rounded-3xl mt-10">
        ...
        <div class="flex justify-between row-inputs">
            <div>
                ...
                <input id="job" v-model="application.position" class="form-auth-input mb-5" />
            </div>
            <div>
                <label class="block mb-2 font-semibold" for="organiztion">
                    Организация
                </label>
                <input id="organization" v-model="application.organization" class="form-auth-input mb-5" />
            </div>
            <div>
                <label class="block mb-2 font-semibold" for="adrees">
                    Адрес организации
                </label>
                <input id="adress" v-model="application.address" class="form-auth-input mb-5" />
            </div>
        </div>
        <hr class="w-full" />
