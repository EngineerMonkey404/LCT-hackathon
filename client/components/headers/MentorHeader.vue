<template>
  <div class="subheader">
    <NuxtLink to="/mentor/applications">
      <div
    ...
    >
      <img
        ...
        "
      />
      <span class="max-sm:hidden">Школа наставников</span>
    </div>
    <NuxtLink>
      <div
        class="header-btn"
      ...
      >
        <img
          ...
          :src="
            current === 'o'
              ? '/mentor/black/calendar_month.svg'
              : '/mentor/white/calendar_month.svg'
          "
        />
        <span class="max-sm:hidden">Расписание стажера</span>
      </div>
    </NuxtLink>
  </div>
</template>
