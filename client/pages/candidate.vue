<template>
  ...
  >
      ...
      <template #link>
        ...
        >
          ...
          <NuxtImg
            class="inline"
            type="svg"
            src="/candidate/arrow_right_alt.svg"
          />
        </button>
      </template>
    </StatusApplication>
    ...
    <StatusApplication
      v-else-if="status === 'wait'"
      class="mt-10"
      img="/candidate/wait.svg"
    >
